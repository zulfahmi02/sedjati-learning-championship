...
test('judges authenticate and are redirected to the judge dashboard', function () {
...
test('admins authenticate and are redirected to the admin dashboard', function () {
