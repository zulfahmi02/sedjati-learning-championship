...
export default function PublicLayout({
    ...
    return (
        <div className="relative flex min-h-screen flex-col overflow-x-clip bg-gradient-to-b from-butter to-[#FFFDF6] dark:from-deep dark:to-background">
            <div
                aria-hidden="true"
            ...
            <header className="fixed top-0 right-0 left-0 z-40 border-b border-leaf/10 bg-white/80 shadow-[0_2px_0_rgba(42,51,31,0.03)] backdrop-blur-md dark:bg-card/85">
                <div className="mx-auto flex h-16 w-full max-w-[1440px] items-center justify-between gap-3 px-4 md:px-6">
                    <div className="flex items-center gap-4">
                        ...
                        >
                            <AppLogoIcon className="size-9 shadow-[0_2px_0_rgba(42,51,31,0.18)]" />
            ...
            <main className="relative z-10 mx-auto w-full max-w-[1440px] flex-1 px-4 pt-24 pb-12 md:px-6">
                {children}
            </main>

            <footer className="relative z-10 border-t border-leaf/10 py-6">
